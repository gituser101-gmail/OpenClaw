...
For OpenClaw workspace parity, local tool notes live in the `## Tools` section of `AGENTS.md` and ride Codex's native project-doc discovery. The Codex harness routes the remaining bootstrap files to the prompt surface matching their lifetime:
