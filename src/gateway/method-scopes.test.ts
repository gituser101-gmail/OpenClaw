...
describe("method scope resolution", () => {
  it.each([
    ...
    ["claws.add.plan", ["operator.read"]],
    ["claws.add.apply", ["operator.admin"]],
    ["claws.update.plan", ["operator.read"]],
    ["claws.update.apply", ["operator.admin"]],
    ["claws.configure.plan", ["operator.read"]],
    ["claws.configure.apply", ["operator.admin"]],
    ["claws.remove.plan", ["operator.read"]],
    ["claws.remove.apply", ["operator.admin"]],
