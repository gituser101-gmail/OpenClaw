...
const CORE_GATEWAY_METHOD_SPECS: readonly CoreGatewayMethodSpec[] = [
  ...
  { name: "claws.catalog.search", scope: "operator.read", since: "2026.7" },
  { name: "claws.catalog.detail", scope: "operator.read", since: "2026.7" },
  { name: "claws.add.plan", scope: "operator.read", since: "2026.7" },
  {
    name: "claws.add.apply",
    scope: "operator.admin",
    since: "2026.7",
    controlPlaneWrite: true,
  },
  { name: "claws.update.plan", scope: "operator.read", since: "2026.7" },
  {
    name: "claws.update.apply",
    scope: "operator.admin",
    since: "2026.7",
    controlPlaneWrite: true,
  },
  { name: "claws.configure.plan", scope: "operator.read", since: "2026.7" },
  {
    name: "claws.configure.apply",
    scope: "operator.admin",
    since: "2026.7",
    controlPlaneWrite: true,
  },
  { name: "claws.remove.plan", scope: "operator.read", since: "2026.7" },
  {
    name: "claws.remove.apply",
    scope: "operator.admin",
    since: "2026.7",
    controlPlaneWrite: true,
  },
