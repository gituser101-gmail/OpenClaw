...
export const en: TranslationMap = {
  ...
  clawsPage: {
    ...
    catalogUnavailable: "ClawHub discovery is not available on this Gateway.",
    searchLabel: "Search ClawHub",
    searchPlaceholder: "Financial analyst, research, support…",
    search: "Search",
    searchEmpty: "Search ClawHub to find a portable agent setup.",
    selectCatalog: "Select a Claw to inspect its contents.",
    multipleInstalled:
      "Multiple agents use this Claw. Select the intended agent in Installed before previewing an update.",
    official: "Official",
    scanStatus: "Security scan",
    healthy: "Healthy",
    ...
    setup: {
      ...
      clear: "Clear stored answer",
      regenerate: "Regenerate selected workspace files",
      review: "Review changes",
      connections: "Connections needed after add",
      connectOwners: "Connect the required integrations: {owners}",
    },
    plan: {
      title: "Claw lifecycle preview",
      heading: "{operation} Claw",
      preview: "Preview",
      blocked: "Blocked",
      actions: "Changes",
      capabilities: "Capabilities requiring consent",
      blockers: "Blockers",
      removeUnused:
        "Also remove referenced packages and integrations that are unused outside this Claw.",
      acknowledgeRisk:
        "I understand this ClawHub release has a security warning and want to continue.",
      confirm: "{operation} Claw",
      applying: "Applying…",
    },
    errors: {
      ...
      invalidPlan: "Gateway returned an invalid Claw lifecycle preview.",
      invalidOutcome: "Gateway returned an invalid Claw lifecycle outcome.",
    },
    resourceKinds: {
      agent: "Agent",
