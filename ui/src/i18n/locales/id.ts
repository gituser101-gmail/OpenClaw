...
export const id: TranslationMap = {
  ...
  labsPage: {
    ...
    loopDetection: {
      ...
      description:
        "Aktifkan pengaman riwayat bergulir yang memperingatkan atau memblokir panggilan alat berulang saat agen berhenti membuat kemajuan.",
    },
    localModelLean: {
  ...
  dreaming: {
    ...
    phrases: {
      ...
      defragmentingMemoryLane: "mendefragmentasi jejak memori…",
  ...
  chat: {
    ...
    composer: {
      ...
      menu: {
        ...
        scopeSessionHint:
          "Server disimpan dinonaktifkan secara global dan diaktifkan hanya untuk sesi ini.",
        scopeEverywhereHint: "Server disimpan dan diaktifkan untuk setiap sesi.",
        toolAccess: {
          label: "Akses alat",
          loading: "Memuat alat…",
          loadFailed: "Tidak dapat memuat alat.",
          noTools: "Tidak ada alat tersedia untuk konektor ini.",
